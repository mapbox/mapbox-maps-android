...
/**
 * Fire-and-forget animation function for Zoom as [Double]. When the provided [targetValue] is changed, the
 ...
 *
 * [animateZoomAsState] returns a [State] object. The value of the state object will continuously
 * be updated by the animation until the animation finishes.
 *
 * Note, [animateZoomAsState] cannot be canceled/stopped without removing this composable function
...
/**
 * Creates a Zoom animation as a part of the given [Transition]. This means the states
...
@Composable
@MapboxExperimental
public inline fun Transition<CameraState>.animateZoom(
