...
* Enable [pitch] and [distance-from-center] style expressions ([1650](https://github.com/mapbox/mapbox-maps-android/pull/1650))
...
* Add custom layer support for rendering (draping) to terrain and globe surface. (https://github.com/mapbox/mapbox-gl-js/pull/11996) ([1650](https://github.com/mapbox/mapbox-maps-android/pull/1650))
* Introduce fill-extrusion-edge-radius property for smoother extrusion appearance. ([1650](https://github.com/mapbox/mapbox-maps-android/pull/1650))
...
* Fix shadowing artifacts in certain combinations of camera and light direction ([1650](https://github.com/mapbox/mapbox-maps-android/pull/1650))
...
* Fixed a race condition when calling flush() on the MetricsService that could result in the callback being called twice. ([1650](https://github.com/mapbox/mapbox-maps-android/pull/1650))
...
* Avoid to create shadow renderpass if there are no layers casting shadows ([1650](https://github.com/mapbox/mapbox-maps-android/pull/1650))
