 ...
 */
class StandardIndoorLabels @JvmOverloads constructor(
  /**
   * Optional import id when using Mapbox Standard Style as a style import for another style.
   */
  val importId: String? = null,
) : TypedFeaturesetDescriptor<StandardIndoorLabelsState, StandardIndoorLabelsFeature>() {
   ...
   * For internal usage.
   */
  override fun getFeatureState(rawState: Value) = StandardIndoorLabelsState(rawState)
  ...
  internal companion object {
    internal const val FEATURESET_ID = "indoor-labels"
  }
}