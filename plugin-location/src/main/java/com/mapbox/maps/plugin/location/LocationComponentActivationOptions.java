...
public class LocationComponentActivationOptions {
  ...
  private LocationComponentActivationOptions(@NonNull Context context, @NonNull StyleInterface style,
                                             ...
                                             @Nullable LocationModelLayerOptions locationModelLayerOptions) {
  ...
  @Nullable
  public LocationModelLayerOptions getLocationModelLayerOptions() {
    return locationModelLayerOptions;
  }
  ...
  public static class Builder {
    ...
    private LocationModelLayerOptions locationModelLayerOptions;
     ...
     *                                 (Context, MapStyleDelegate)#locationEngine()}.
     * @return the {@link Builder} object being constructed
     */
    ...
    public LocationComponentActivationOptions build() {
      ...
      if (style == null) {
        throw new NullPointerException(
          "MapStyleDelegate in LocationComponentActivationOptions is null. Make sure the "
            + "MapStyleDelegate object isn't null. Wait for the map to fully load before passing "
            + "the MapStyleDelegate object to LocationComponentActivationOptions.");
      }
      // TODO tailwork of https://github.com/mapbox/mapbox-maps-android/issues/753
      /*if (!style.isFullyLoaded()) {
        throw new IllegalArgumentException(
          "MapStyleDelegate in LocationComponentActivationOptions isn't fully loaded. Wait for the "
            + "map to fully load before passing the MapStyleDelegate object to "
