...
class MapTelemetryEventServieTest {
  ...
  fun setUp() {
    ...
    val options = EventsServiceOptions("empty", "empty", "empty")
  ...
  fun testSetUserTelemetryRequestStateDisabled() {
    ...
    Assert.assertFalse(EventsService.getEventsCollectionState())
  }
  ...
  fun testSetUserTelemetryRequestStateEnabled() {
    ...
    Assert.assertTrue(EventsService.getEventsCollectionState())
  }
