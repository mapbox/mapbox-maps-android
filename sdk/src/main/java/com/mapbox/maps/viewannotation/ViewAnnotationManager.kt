...
interface ViewAnnotationManager {
   ...
   *
   * @param resId layout resource id
   * @param id an optional identifier for view annotation. if provided, view annotation will be added with
   * provided id, else view annotation id will be autogenerated.
   * @param options view annotation options
   *
   * @return inflated [View].
   *
  ...
  /**
   * Find [View] by id if it was provided when adding view annotation
   *
   * @param id identifier for [view] annotation.
   ...
   * @return true if view was removed and false if view was not found on the map.
   */
  fun removeViewAnnotation(id: String): Boolean
