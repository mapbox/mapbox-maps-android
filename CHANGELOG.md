...
* Throw exception when constructing Value with `Double.NaN`, so we get meaningful crash stacktrace early. ([1681](https://github.com/mapbox/mapbox-maps-android/pull/1681))
