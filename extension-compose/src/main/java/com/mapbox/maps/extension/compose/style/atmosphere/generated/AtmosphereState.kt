 ...
 * initial state.
 *
 * This function does not automatically update the [AtmosphereState] if [key] is updated.
 * To update state properties imperatively, use [LaunchedEffect]:
 * ```kotlin
 * val atmosphere = rememberAtmosphereState()
 * LaunchedEffect(color) {
 *   atmosphere.color = ColorValue(color)
 * }
 * ```
 *
