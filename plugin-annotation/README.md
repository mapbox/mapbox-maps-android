...
The Mapbox Maps Annotation Plugin for Android is an open source library for displaying Annotations(including Line/Circle/Symbol/Fill) on top of MapView.
