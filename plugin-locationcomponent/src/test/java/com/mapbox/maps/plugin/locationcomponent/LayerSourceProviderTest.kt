...
class LayerSourceProviderTest {
  ...
  fun testGetModelLayer() {
    ...
    assertEquals(
      "{model-receive-shadows=true, model-type=location-indicator, model-rotation=[3.0, 2.0, 1.0], model-cast-shadows=true, id=mapbox-location-model-layer, source=mapbox-location-model-source, type=model, model-scale=[1.0, 2.0, 3.0], model-translation=[0.0, 0.0, 0.0]}",
