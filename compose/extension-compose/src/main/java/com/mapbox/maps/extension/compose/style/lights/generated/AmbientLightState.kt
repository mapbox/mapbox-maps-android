 ...
 * initial state.
 *
 * This function does not automatically update the [AmbientLightState] if [key] is updated.
...
): AmbientLightState = rememberSaveable(id, key = key, saver = AmbientLightState.Saver) {
