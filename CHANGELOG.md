...
* Throw exception when constructing `Value` with not a finite number, so we get meaningful crash stacktrace early. ([1681](https://github.com/mapbox/mapbox-maps-android/pull/1681))
