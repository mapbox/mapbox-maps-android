...
* Add location compass engine for the location component to show device heading correctly. ([#970](https://github.com/mapbox/mapbox-maps-android/pull/970))
...
* Fix memory leak in view annotations caused by not removing properly global layout listener. ([#1037](https://github.com/mapbox/mapbox-maps-android/pull/1037))
