...
class ModelLayer(override val layerId: String, val sourceId: String) : ModelLayerDsl, Layer() {
   ...
   */
  @MapboxExperimental
  override fun modelAmbientOcclusionIntensity(modelAmbientOcclusionIntensity: Double) = apply {
   ...
   */
  @MapboxExperimental
  override fun modelAmbientOcclusionIntensity(modelAmbientOcclusionIntensity: Expression) = apply {
    val propertyValue = PropertyValue("model-ambient-occlusion-intensity", modelAmbientOcclusionIntensity)
    setProperty(propertyValue)
  }
   ...
   */
  @MapboxExperimental
  override fun modelAmbientOcclusionIntensityTransition(options: StyleTransition) = apply {
   ...
   */
  @MapboxExperimental
  override fun modelAmbientOcclusionIntensityTransition(block: StyleTransition.Builder.() -> Unit) = apply {
  ...
  val modelScaleMode: ModelScaleMode?
    ...
    get() {
      getPropertyValue<String?>("model-scale-mode")?.let {
        return ModelScaleMode.valueOf(it.toUpperCase(Locale.US).replace('-', '_'))
      }
      return null
    }
   ...
   */
  @MapboxExperimental
  override fun modelScaleMode(modelScaleMode: ModelScaleMode) = apply {
   ...
   */
  @MapboxExperimental
  override fun modelScaleMode(modelScaleMode: Expression) = apply {
    val propertyValue = PropertyValue("model-scale-mode", modelScaleMode)
    setProperty(propertyValue)
  }
