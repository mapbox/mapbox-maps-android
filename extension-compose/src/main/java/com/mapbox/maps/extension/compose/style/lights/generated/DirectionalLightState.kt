 ...
 * initial state.
 *
 * This function does not automatically update the [DirectionalLightState] if [key] is updated.
 * To update state properties imperatively, use [LaunchedEffect]:
 * ```kotlin
 * val light = rememberDirectionalLightState()
...
): DirectionalLightState = rememberSaveable(id, key = key, saver = DirectionalLightState.Saver) {
