 ...
 */
abstract class LocationComponentSettingsBase2 : LocationComponentSettingsInterface2 {
  /**
   * Shows a location puck on the map.
   */
  protected abstract var internalSettings: LocationComponentSettings
  protected abstract var internalNewSettings: LocationComponentNewSettings
  ...
  override var newSettings: Boolean
    get() = this.internalNewSettings.newSetting
    set(value) {
      this.internalNewSettings.newSetting = value
      applySettings()
    }
}
