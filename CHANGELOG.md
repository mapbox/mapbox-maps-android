...
## Breaking changes ⚠️
* Improve camera API consumption from java programming language by adding a JvmName annotations. ([#495](https://github.com/mapbox/mapbox-maps-android/pull/495))
...
* Add lifecycle plugin, users don't need to call onStart/onStop/onDestroy methods with this plugin ([#485](https://github.com/mapbox/mapbox-maps-android/pull/485))
...
* Get rid of reflection for creating plugins. That will lead to decreasing MapView startup time if plugins are enabled. ([#519](https://github.com/mapbox/mapbox-maps-android/pull/519))
