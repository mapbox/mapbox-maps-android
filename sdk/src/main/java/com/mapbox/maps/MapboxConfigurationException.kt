...
class MapboxConfigurationException : RuntimeException {
  ...
  constructor() : super(
    """
      ...
      Provide the token by creating a $MAPBOX_ACCESS_TOKEN_RESOURCE_NAME string resource or by passing it using MapView's 'mapbox_resourcesAccessToken' XML attribute.
