...
include(":app",":sdk", ":extension-observable", ":extension-style", ":plugin-overlay", ":plugin-compass",":plugin-logo",  ":plugin-scalebar", ":plugin-gestures", ":plugin-attribution", ":plugin-annotation", ":plugin-location", ":plugin-locationcomponent", ":plugin-animation", ":module-loader", ":module-telemetry", ":sdk-base", ":extension-style-app")
