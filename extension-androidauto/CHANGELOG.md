...
* Change `MapboxCarMapGestureHandler` to an abstract class so methods can be added without breaking java backwards compatibility. ([#1670](https://github.com/mapbox/mapbox-maps-android/pull/1670))
